...
(function (global, factory) {
  ...
  const variationPlacements = /* #__PURE__ */ basePlacements.reduce(
    (acc, placement) =>
  ...
  */
  ...
  function computeAutoPlacement(state, options) {
    ...
    const placements$1 = variation
      ...
      : basePlacements;
    let allowedPlacements = placements$1.filter(
  ...
  function flip(_ref) {
    ...
    const placements = [preferredPlacement].concat(fallbackPlacements).reduce(
      (acc, placement) =>
        acc.concat(
